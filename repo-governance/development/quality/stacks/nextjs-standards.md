...
It implements Explicit Over Implicit, Simplicity Over Complexity, Fail Closed, and Evidence Over Assertion. It builds on
...
- **Pages, layouts, actions, and handlers hold no business rules.** They are the presentation adapter Application Shapes
  describes.
...
[Test Boundaries and Gates](../../quality-gates.md), and whether coverage has a floor is recorded under
