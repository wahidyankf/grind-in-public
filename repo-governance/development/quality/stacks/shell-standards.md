...
- **Static analysis:** every script is analysed at the threshold [Lint Strictness](../../testing-policy/tooling.md)
  sets, each directive that disables a check carrying its reason. Example: ShellCheck.
...
isolation per [Git Fixture Isolation](../../test-data-isolation.md) and
[Test Data Isolation](../../test-data-isolation.md), and is classified by the boundary it touches under
[Test Boundaries and Gates](../../quality-gates.md). Example: bats-core.
