...
It implements Explicit Over Implicit, Immutability, and Automation Over Manual. The interpreter version and lockfile
follow [Native-First Toolchain](../../testing-policy/tooling.md) and Reproducibility.
...
[Test Boundaries and Gates](../../quality-gates.md) classifies it. Example: pytest, whose `tmp_path` and
...
give. A change to observable behaviour updates them per [Specification Maintenance](../../specs-policy.md) and Public
Contract.
