...
It implements Explicit Over Implicit, Immutability, Reproducibility, and Automation Over Manual. React code also follows
...
[Native-First Toolchain](../../testing-policy/tooling.md).
...
structured as Functional Core, Imperative Shell or, where ports exist, Hexagonal Architecture.
...
Findings fail at the threshold [Lint Strictness](../../testing-policy/tooling.md) sets, and each gate is a named target
as [Test Boundaries and Gates](../../quality-gates.md) requires. Behaviour is built test-first per
[Test-Driven Development](../../tdd-policy.md). A test that intercepts network requests in process is a unit test, never
integration evidence. Whether coverage has a floor is recorded under [Layers and Adapters](../../quality-gates.md).
