---
tldr: >-
  Indexes the ordered modules that define criticality levels, confidence and re-validation, and the priority order and
  report format built from both.
when_to_use: >-
  Use to locate the module covering how a finding is rated, re-validated, prioritized, or reported.
---

# Finding Criticality and Confidence Modules
...
- [001 Criticality Levels](001-criticality-levels.md)
- [002 Confidence and Re-Validation](002-confidence-and-revalidation.md)
- [003 Priority and Reporting](003-priority-and-reporting.md)
