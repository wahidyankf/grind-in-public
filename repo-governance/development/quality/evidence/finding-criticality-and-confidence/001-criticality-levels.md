...
Results and dispositions follow Quality Gate Results. Treating `HIGH` as blocking unless dispositioned is deliberately
the stricter choice: a significant problem left without a recorded decision is silence, and silence afterwards looks
exactly like oversight.
