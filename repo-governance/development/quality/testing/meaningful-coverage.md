...
Whether a floor exists is recorded under [Layers and Adapters](../../quality-gates.md). Which run gates coverage, and
how each exclusion is named, belong to [Test Boundaries and Gates](../../quality-gates.md). A measured figure is read as
Trustworthy Measurement requires.
...
[Task Runner Target Standards](../../testing-policy.md) forbids. The stack standard names its native verification.
