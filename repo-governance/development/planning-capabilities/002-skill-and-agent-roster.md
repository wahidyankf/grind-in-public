---
tldr: "Fixes the six planning skills, the three plan agents, and the one-copy rule."
when_to_use: "Use when adding, renaming, or generating a planning skill or agent."
---
