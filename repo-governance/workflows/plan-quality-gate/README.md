...
Detail behind the [plan-quality-gate](../plan-quality-gate.md) workflow. Filenames are numbered; the
...
- [Plan Minimum Sufficiency](05-minimum-sufficiency.md) — retaining only plan artifacts needed for scope, safety,
