...
[Project READMEs](../../project-readme-policy.md) state each project's stack, commands, and test levels, and
[Test Boundaries and Gates](../../../development/quality-gates.md) places every omitted target and its reason there. The
adapter links each project README instead of copying those facts. A project without a README carries them inline in the
adapter until it gains one.
...
- **Adopter Decisions.** Every Adopter Decision row of each adopted standard and skill, plus the coverage-floor and
  task-runner choices that [Layers and Adapters](../../../development/quality-gates.md) and Test Boundaries and Gates
  ask a repository to record. A stronger local rule, such as a higher coverage floor or a language confined to one
  project, is recorded here as a deviation with its reason, and adoption never loosens it.
...
[File Naming](../../document-naming-policy.md) requires.
