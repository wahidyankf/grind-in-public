---
tldr: "Fixes the shape of machine-readable output and the namespaced error code it carries."
when_to_use: "Use when adding a machine-readable mode or a new error code."
---
