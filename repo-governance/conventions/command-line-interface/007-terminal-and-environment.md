---
tldr: "Fixes terminal detection, colour, and the environment variables a tool honours."
when_to_use: "Use when adding colour, progress output, or an environment variable."
---
