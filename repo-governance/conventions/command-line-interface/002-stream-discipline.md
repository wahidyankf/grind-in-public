---
tldr: "Separates the answer on standard output from the narration on standard error."
when_to_use: "Use when a tool prints anything, and before adding output to a pipeline."
---
