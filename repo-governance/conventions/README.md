...
- [Structure Conventions](structure/README.md) — where stack packs, their repository adapter, and the
  software-development inventory live. Use it when adopting, locating, or recording a stack pack.
