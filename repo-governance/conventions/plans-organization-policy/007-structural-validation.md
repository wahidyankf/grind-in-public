---
tldr: "Separates what a validator checks mechanically from what only review can judge."
when_to_use: "Use when deciding whether a plan rule belongs in a checker or in review."
---
