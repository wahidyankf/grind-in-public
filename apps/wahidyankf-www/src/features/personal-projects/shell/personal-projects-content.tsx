...
import {
  projects,
  filterProjects,
} from "@/features/personal-projects/core/projects";
          ...
          >
            ...
            <p className="mb-2 text-green-300">
              ...
              <span className="ml-2 text-yellow-400">
                (
                <HighlightText
                  text={formatDuration(calculateDuration(project.period))}
                  searchTerm={searchTerm}
                />
                )
              </span>
            ...
            {(() => {
              const tags = [
                ...
                ...project.programmingLanguages.map((name) => ({
                  name,
                  icon: Code,
                })),
...
/**
 * Renders the personal projects page: the navigation, the page frame, and the
 * project list inside it. This is the component the route imports; the list
 * itself is `ProjectsContent` above.
 */
