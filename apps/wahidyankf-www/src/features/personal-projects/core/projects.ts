...
/**
 * Filters the project list by one free-text term, matched against every field
 * a reader would plausibly search by: the title, the description, the details,
 * and each of the three skill lists. The searchable fields are spelled out
 * rather than derived from the type, which makes adding a field to `Project` a
 * deliberate decision about whether it should be searchable.
 */
