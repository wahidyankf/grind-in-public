...
export const SearchComponent: React.FC<SearchComponentProps> = ({
  ...
  clearButtonClassName = "absolute top-1/2 right-3 -translate-y-1/2 transform bg-yellow-400 p-1 text-gray-900 transition-colors duration-200 hover:bg-yellow-300",
}) => {
