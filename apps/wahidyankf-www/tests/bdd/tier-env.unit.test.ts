 ...
 *
 * Covers: specs/apps/wahidyankf-www/behavior/tier-env-loading.feature
 *
...
const feature = await loadFeature(
  path.resolve(
    process.cwd(),
    "../../specs/apps/wahidyankf-www/behavior/tier-env-loading.feature",
  ),
);
...
describeFeature(feature, ({ Scenario, ScenarioOutline, AfterEachScenario }) => {
  ...
  Scenario("Loads the selected tier's file", ({ Given, When, Then }) => {
    ...
    // @covers specs/apps/wahidyankf-www/behavior/tier-env-loading.feature:Loads the selected tier's file
  ...
  Scenario(
    ...
    ({ Given, When, Then, And }) => {
      ...
      // @covers specs/apps/wahidyankf-www/behavior/tier-env-loading.feature:Process env always wins over the tier file
  ...
  Scenario("Tolerates a missing tier file", ({ Given, When, Then, And }) => {
    ...
    // @covers specs/apps/wahidyankf-www/behavior/tier-env-loading.feature:Tolerates a missing tier file
  ...
  ScenarioOutline(
    ...
    ({ Given, When, Then }, examples) => {
      ...
      // @covers specs/apps/wahidyankf-www/behavior/tier-env-loading.feature:Fails loudly on a stray auto-loaded env file
      Then(
  ...
  Scenario(
    ...
    ({ Given, When, Then }) => {
      ...
      // @covers specs/apps/wahidyankf-www/behavior/tier-env-loading.feature:Tolerates a stray file at the local tier
      Then("the loader does not throw", () => {
        expect(thrown).toBeUndefined();
      });
    },
