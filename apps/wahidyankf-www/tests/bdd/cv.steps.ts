...
const feature = await loadFeature(
  path.resolve(
    process.cwd(),
    "../../specs/apps/wahidyankf-www/behavior/cv.feature",
  ),
);
...
describeFeature(feature, ({ Scenario, Background }) => {
  ...
  Scenario("CV renders the Curriculum Vitae heading", ({ When, Then }) => {
    ...
    // @covers specs/apps/wahidyankf-www/behavior/cv.feature:CV renders the Curriculum Vitae heading
  ...
  Scenario("CV renders a search input", ({ When, Then }) => {
    ...
    // @covers specs/apps/wahidyankf-www/behavior/cv.feature:CV renders a search input
    Then(
  ...
  Scenario("CV renders the Highlights section header", ({ When, Then }) => {
    ...
    // @covers specs/apps/wahidyankf-www/behavior/cv.feature:CV renders the Highlights section header
  ...
  Scenario(
    ...
    ({ When, Then }) => {
      ...
      // @covers specs/apps/wahidyankf-www/behavior/cv.feature:CV cross-linked via scrollTop query scrolls into the entries
  ...
  Scenario("CV offers a downloadable PDF", ({ When, Then }) => {
    ...
    // @covers specs/apps/wahidyankf-www/behavior/cv.feature:CV offers a downloadable PDF
    Then(
