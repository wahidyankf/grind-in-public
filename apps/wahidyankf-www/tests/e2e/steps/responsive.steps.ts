...
When(
  "a visitor opens the home page at 1440 by 900 viewport",
  async ({ page }) => {
...
When(
  "a visitor opens the home page at 768 by 1024 viewport",
  async ({ page }) => {
...
When(
  "a visitor opens the home page at 375 by 812 viewport",
  async ({ page }) => {
...
Then(
  "the theme toggle button is present in the DOM and clickable",
  async ({ page }) => {
