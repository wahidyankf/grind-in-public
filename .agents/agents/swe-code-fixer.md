...
description: >-
  ...
  every disposition. Use once a code checker has returned findings for the current revision of the projects in scope,
  rather than when a command is failing or new behaviour is needed.
mode: subagent
requires:
  - repository-read
  - repository-write
