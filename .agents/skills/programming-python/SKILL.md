...
[Preexisting Error Resolution](../../../repo-governance/principles/root-cause-orientation.md). A path left outside
strict mode without a stated reason is a finding to raise, not a place to add code.
