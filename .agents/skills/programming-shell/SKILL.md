...
[Preexisting Error Resolution](../../../repo-governance/principles/root-cause-orientation.md). For a dialect the
analyser cannot read, the syntax check passes and you carry the review the analyser would have done.
