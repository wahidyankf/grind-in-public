...
Claude Code discovers these agents automatically from this directory. It ignores this README because the file carries no agent frontmatter.
...
Each role is mirrored in [`.codex/agents/`](../../.codex/agents/README.md) and [`.opencode/agents/`](../../.opencode/agents/README.md) and must stay at parity; see the [harness capability parity policy](../../repo-governance/conventions/harness-capability-parity-policy.md).
