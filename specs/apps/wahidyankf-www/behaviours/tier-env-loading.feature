Feature: Tier env-file loader module
  ...
  # Exemption(e2e): Local configuration behaviour is not observable through the browser boundary; alternative-proof: wahidyankf-www:test:integration / Loads the selected tier's file
  @e2e-exempt
  ...
  # Exemption(e2e): Local configuration behaviour is not observable through the browser boundary; alternative-proof: wahidyankf-www:test:integration / Process env always wins over the tier file
  @e2e-exempt
  ...
  # Exemption(e2e): Local configuration behaviour is not observable through the browser boundary; alternative-proof: wahidyankf-www:test:integration / Tolerates a missing tier file
  @e2e-exempt
  ...
  # Exemption(e2e): Local configuration behaviour is not observable through the browser boundary; alternative-proof: wahidyankf-www:test:integration / Fails loudly on a stray auto-loaded env file
  @e2e-exempt
  ...
  # Exemption(e2e): Local configuration behaviour is not observable through the browser boundary; alternative-proof: wahidyankf-www:test:integration / Tolerates a stray file at the local tier
  @e2e-exempt
