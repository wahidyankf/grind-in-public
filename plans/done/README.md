...
Completed plans, named `YYYY-MM-DD__<identifier>/` using the date the final commit landed. They are history, not documentation, and their value comes from being accurate rather than tidy — including about what went badly.
